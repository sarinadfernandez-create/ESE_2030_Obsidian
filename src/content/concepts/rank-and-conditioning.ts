    ...
    problems: [
      {
        id: 'P-1.8a',
        difficulty: 1,
        statement: 'Find the rank of $A = \\begin{pmatrix} 1 & 2 & 1 \\\\ 0 & 1 & 1 \\\\ 0 & 0 & 0 \\end{pmatrix}$.',
        hint: 'The matrix is already in REF. Just count the pivots.',
        hasAnimatedSolution: false,
      },
      {
        id: 'P-1.8b',
        difficulty: 2,
        statement: 'Show that the rank of $A$ equals the rank of $A^T$.',
        hint: 'The rank of $A$ is the number of pivots in its RREF, which equals the number of linearly independent rows. The rank of $A^T$ counts the linearly independent rows of $A^T$, which are the columns of $A$. The equality is the deep statement that "row rank = column rank."',
        hasAnimatedSolution: false,
      },
      {
        id: 'P-1.8c',
        difficulty: 2,
        statement: 'Compute the condition number of $D = \\text{diag}(1, 0.01)$ in the operator 2-norm. (For a diagonal matrix, $\\|D\\| = \\max_i |D_{ii}|$ and $\\|D^{-1}\\| = \\max_i 1/|D_{ii}|$.)',
        hint: '$\\|D\\| = 1$ and $\\|D^{-1}\\| = 100$, so $\\kappa(D) = 100$. This means up to 2 digits can be lost when solving $Dx = b$.',
        hasAnimatedSolution: false,
      },
      {
        id: 'P-1.8d',
        difficulty: 3,
        statement: 'Show that for any invertible $A$ and any nonzero scalar $c$, $\\kappa(cA) = \\kappa(A)$. (The condition number is invariant under uniform rescaling.)',
        hint: 'Use the homogeneity of the operator norm: $\\|cA\\| = |c| \\|A\\|$ and $\\|(cA)^{-1}\\| = |c|^{-1} \\|A^{-1}\\|$.',
        hasAnimatedSolution: false,
      },
    ],
  },
